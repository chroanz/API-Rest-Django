...
def createUser(request):
    ...
    messagem = "Usuário " + user.username + " criado!"

    return Response({'message':messagem})
...
def loginUser(request):
    ...
    if user:
        ...
        return Response({"message":"Usuário ou senha errados!"})
...
def criarTarefa(request):
    if request.user.is_authenticated:
        ...
        return Response({"Mensagem":"Usuáro não logado!"})
...
def concluirTask(request):
    try:
        ...
        if request.user.is_authenticated:
            ...
            tarefa.save()
            mensagem = "A tarefa de título " + tarefa.titulo + " foi concluída."
            return Response({"message":mensagem})
    except:
        return Response({"Mensagem":"Precisa-se de um ID válido"})
